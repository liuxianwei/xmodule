...
@FeignClient(name="springcloud-nacos-producer", qualifier="appInfoApiService", contextId="appInfoApiService", fallbackFactory=CommonHystrixFallbackFactory.class)
