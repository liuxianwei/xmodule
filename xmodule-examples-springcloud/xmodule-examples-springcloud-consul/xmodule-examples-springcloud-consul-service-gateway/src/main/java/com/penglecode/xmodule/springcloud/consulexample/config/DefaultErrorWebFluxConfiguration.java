...
public class DefaultErrorWebFluxConfiguration extends AbstractSpringConfiguration {
	...
	public DefaultErrorWebFluxConfiguration(ServerProperties serverProperties,
