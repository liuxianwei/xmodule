...
public class ContentType {
	...
	public static final String APPLICATION_WORD = "application/vnd.openxmlformats-officedocument.wordprocessingml.document;charset=UTF-8";
