...
/**
 * 非UPMS的普通Shiro应用的认证Filter
 * 
 * @author 	pengpeng
 * @date	2018年6月16日 下午5:07:37
 */
public class GeneralAppAuthenticationFilter extends AuthenticationFilter implements UnauthenticatedUrlAware {

	private static final Logger LOGGER = LoggerFactory.getLogger(GeneralAppAuthenticationFilter.class);
