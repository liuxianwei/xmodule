...
import com.penglecode.xmodule.common.web.support.DefaultErrorAttributes;
import com.penglecode.xmodule.common.web.support.DefaultErrorController;
...
public class DefaultErrorMvcConfiguration extends AbstractSpringConfiguration {
	...
	public DefaultErrorMvcConfiguration(ServerProperties serverProperties, ObjectProvider<List<ErrorViewResolver>> errorViewResolversProvider) {
		super();
