...
@Configuration
@ConditionalOnProperty(prefix="example", name="running", havingValue=E2eExample1Configuration.EXAMPLE_APP_NAME)
public class E2eExample1Configuration extends AbstractSpringConfiguration {

	public static final String EXAMPLE_APP_NAME = "e2e_example1";
